...
channel = {7:{8:1,9:2},8:{7:2,9:4},9:{7:1,8:5}}
...
'''
def generate_mesh_path(adj,srcmac,dstmac):
  ...
  for i in range(,len(path)):
    mesh_path[i] = (switches[path[i-2]], adjacency[switches[path[i-2]]][switches[path[i-3]]] , adjacency[switches[path[i-2]]][switches[path[i-1]]] )
  #print mesh_path
