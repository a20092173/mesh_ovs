...
PATH_SETUP_TIME = 4
hostip = '192.168.1.145'
_7_bat = '1E:EE:F0:FB:FB:55'
...
class Switch (EventMixin):
  ...
  def __repr__ (self):
    print 'return dpid_to_str(self.dpid)'
  ...
  def _handle_PacketIn (self, event):
    ...
    def change():
      ...
      for i in switches.keys():
        #if int(event.dpid) is 7:
        if i is 7:
          log.info('77777777777777777777into change()')
          msg = of.ofp_flow_mod()
          msg.match.in_port = 6
          ...
          #msg.actions.append(of.ofp_action_nw_addr.set_dst(IPAddr('192.168.1.113')))
          #msg.actions.append(of.ofp_action_dl_addr.set_src(EthAddr(_7_bat)))
          msg.actions.append(of.ofp_action_dl_addr.set_dst(EthAddr(_9_bat)))
          #msg.actions.append(of.ofp_action_nw_tos(nw_tos = 32))
          msg.actions.append(of.ofp_action_output(port = 0xfff8))
          #msg.actions.append(of.ofp_action_output(port = 6))
          switches[i].connection.send(msg)
        #if int(event.dpid) is 8:
        if int(i) is 8:  
          log.info('888888888888888888888into change()')
          msg = of.ofp_flow_mod()
          msg.match.in_port = 4
          msg.match.dl_type = 0x800
          msg.match.nw_tos= 0
          ...
          #msg.actions.append(of.ofp_action_output(port = 6))
          #msg.actions.append(of.ofp_action_nw_addr.set_dst(IPAddr('192.168.1.113')))
          #msg.actions.append(of.ofp_action_dl_addr.set_src(EthAddr(_8_bat)))
          msg.actions.append(of.ofp_action_dl_addr.set_dst(EthAddr(_7_bat)))
          #msg.actions.append(of.ofp_action_nw_tos(nw_tos = 32))
          #msg.actions.append(of.ofp_action_output(port = 0xfff8))
          msg.actions.append(of.ofp_action_output(port = 6))
          '''          
          msg.actions.append(of.ofp_action_dl_addr.set_src(EthAddr('9A:ED:74:DE:D4:21')))
          msg.actions.append(of.ofp_action_dl_addr.set_dst(EthAddr('BA:56:08:B4:D5:9C')))
          #msg.actions.append(of.ofp_action_nw_addr.set_src(IPAddr('10.0.0.8')))
          #msg.actions.append(of.ofp_action_nw_addr.set_dst(IPAddr('10.0.0.9')))
          msg.actions.append(of.ofp_action_nw_tos(nw_tos = 32))
          msg.actions.append(of.ofp_action_output(port = 6))
          '''
          switches[i].connection.send(msg)
          ...
          msg.actions.append(of.ofp_action_nw_tos(nw_tos = 32))   
          msg.actions.append(of.ofp_action_dl_addr.set_src(EthAddr('9A:ED:74:DE:D4:21')))
          msg.actions.append(of.ofp_action_dl_addr.set_dst(EthAddr('D6:4D:3B:9C:88:B1'))) 
          msg.actions.append(of.ofp_action_output(port = 6))   
          self.connection.send(msg)       
          '''
        #if int(event.dpid) is 9:
        if i is 9:
          log.info('999999999999999999999into change()')
          msg = of.ofp_flow_mod()
          msg.match.in_port = 6
          msg.match.dl_type = 0x800
          msg.match.nw_tos= 0
          msg.match.nw_proto=17
          msg.match.nw_src = IPAddr("10.0.0.60")
          #msg.match.dl_src = EthAddr("28:C6:8E:A6:6A:73")
          #msg.match.tp_src = 50002
          msg.idle_timeout = 10
          msg.hard_timeout = 30          
          #msg.actions.append(of.ofp_action_output(port = 6))
          #msg.actions.append(of.ofp_action_nw_addr.set_dst(IPAddr('192.168.1.113')))
          #msg.actions.append(of.ofp_action_dl_addr.set_src(EthAddr(_9_bat)))
          msg.actions.append(of.ofp_action_dl_addr.set_dst(EthAddr('00:21:97:3B:3C:C2')))
          #msg.actions.append(of.ofp_action_nw_addr.set_src(IPAddr('10.0.0.9')))
          #msg.actions.append(of.ofp_action_nw_addr.set_dst(IPAddr('10.0.0.50')))          
    ...
    #ip_packet = packet.find('ipv4')
      ...
      #flag_protocol = ip_packet.protocol

    loc = (self, event.port) # Place we saw this ethaddr
    oldloc = mac_map.get(packet.src) # Place we last saw this ethaddr

    #if changeip.srcip is hostip and changeip.protocol is changeip.UDP_PROTOCOL:
      #print '###############################'
      #change()
    ...
    if oldloc is None:#get the switch and port connected to host
      ...
      if loc[1] not in adjacency[loc[0]].values():
        ...
        #drop()
        #return
    if handle_IP_packet(packet) == 17: 
          print 'udp  enter  change()########'
          change()
    else:
      if packet.dst.is_multicast:
        ...
        if packet.dst not in mac_map:
          ...
          #log.info("******$$$$$$$$$$$$$$$$$$$$$******")
          log.info(handle_IP_packet(packet))
          #if handle_IP_packet(packet) == 17: 
            #log.info("*************************")
            #change()
            #pass
...
class l2_multi (EventMixin):
  ...
  def _handle_ConnectionUp (self, event):
    ...
    if sw is None:
      ...
      sw.connect(event.connection)
    print 'switchessssssssssssssssssssssssssssssss'
    print switches.keys()
    print switches
    print 'swwwwwwwwwwwwwwwwwwwwwwwwwww'
    print sw
